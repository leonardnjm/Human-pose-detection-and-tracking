...
while cap.isOpened():
  ...
  image = cv2.circle(image, (int(results.pose_landmarks.landmark[mp_pose.PoseLandmark.NOSE].x*200), int(results.pose_landmarks.landmark[mp_pose.PoseLandmark.NOSE].y*100)), radius=0, color=(255, 0, 255), thickness=100)
